...
const AddProduct = () => {
  ...
  return (
    <div className="no-scrollbar flex-1 has-[95vh] overflow-y-scroll flex 
    flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <button className="px-8 py-2.5 bg-primary cursor-pointer text-white font-medium rounded hover:bg-primary-dull">ADD</button>
            </form>
        </div>
  )
}
